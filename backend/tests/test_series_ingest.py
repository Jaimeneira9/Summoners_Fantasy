...
def test_scoring_engine_damage_share_not_used_for_mid():
    """damage_share no está en los pesos de mid — no debe afectar el score."""
    ...
    assert p_low == p_high, "damage_share no debería afectar score de mid"
